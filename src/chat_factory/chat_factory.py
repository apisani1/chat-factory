...
class ChatFactory:
    ...
    def chat(self, message: str, history: List[Dict[str, Any]]) -> str:
        ...
        def get_reply(extended_history: List[Dict[str, Any]]) -> Tuple[Union[str, BaseModel], List[Dict[str, Any]]]:
        ...
        if self.evaluator_model:
            ...
            while responses < self.response_limit:
                ...
                reply, extended_history = rerun(reply, evaluation.feedback, extended_history)  # type: ignore
                responses += 1
